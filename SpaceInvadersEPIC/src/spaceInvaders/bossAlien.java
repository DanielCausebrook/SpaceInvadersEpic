...
* @author Kevin Glass
 */
public abstract class BossAlienEntity extends Entity {
        public int maxHealth = 5000;
    /** The speed at which the alien moves horizontally */
    protected final double moveSpeed = 65;
     ...
     */
    public BossAlienEntity(Game game,String ref,int x,int y, int row, int col) {
        super(ref,x,y);
                rowNum = row;
                colNum = col;
        this.game = game;
