                ...
                public void mouseClicked(MouseEvent e) {
                    if(mode==1) {
                        if(e.getX()>130&&e.getX()<230&&e.getY()>35&&e.getY()<55) {
                            if(upgradePoints>=5&&xShotPower<30){
                                upgradePoints-=5;
                                xShotPower++;
                                repaint();
                            }
                        ...
                        if(e.getX()>130&&e.getX()<230&&e.getY()>75&&e.getY()<95) {
                            if(upgradePoints>=10&&xBonusPower<10){
                                upgradePoints-=10;
                                xBonusPower++;
                                repaint();
                            }
    ...
    public void paint(Graphics g) {
    	if (currentLevel>=14){
            ...
            if(mode==1) {
                ...
                g.drawString("Shot power extra:",10,50);
                g.drawString("Super shot power extra:",10,90);
                ...
                if(xShotPower<30) {
                    g.drawString("Upgrade   10 pts", 140, 50);
                }
                if(xBonusPower<10) {
                    g.drawString("Upgrade  20 pts", 140, 90);
                }
            } else if (mode==0) {
                g.setColor(Color.WHITE);
